...
parser.add_argument("--data_dir", type=str, default='dataset_sl5.0_vsr3.0_vw64_vh64_asr11025_mfcc', required=True)
parser.add_argument("--batch_size", type=int, default='1',dest='batch_size', required=True)
parser.add_argument("--epochs", type=int, default='2',dest='epochs', required=True)

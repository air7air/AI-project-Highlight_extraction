...
import lol_personal_experiment.util.collection_util as cu
...
def get_segment_label(segment_start_frame, segment_end_frame, hl_section_df):
    ...
    print("시작#####################3")
    print("몰라",segment_start_frame)
    print("1111",segment_end_frame)
    print("")
    print("2222",hl_section_df['hl_end_frame'])# 라벨을 나타내는듯
    print("444",hl_section_df['hl_start_frame']) #jpg 이름 나타냄
    ...
    # h1_segment_start_frame[a & b].to_numpy
    print("에이",segment_start_frame < hl_section_df['hl_end_frame'])
    print("비", segment_end_frame > hl_section_df['hl_start_frame'])
    print("666", intersection_frames)
    ...
    if len(intersection_frames) > 0:
        ...
        print("하이라이트시간",highlight_length)
        print("세그멘트길이",segment_length)
